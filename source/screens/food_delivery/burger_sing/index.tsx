...
type LogInSignUpProps = NativeStackScreenProps<SignUpStackParamList,'Burgersing'>

const Burgersing=({navigation}:LogInSignUpProps)=> {

  const[showprice,Setshowprice]=useState<number[]>([])
  
  return (
    <View style={styles.mainContainer}>
       <Pressable style={styles.companyDetailsBtn} onPress={() =>navigation.navigate("Burgersing")}>
            <View style={styles.innerCompanyDetail}>
                <View>
                
                    <Image style={styles.img} source={require("../../../assests/images/burgersing.jpeg")} />
                </View>
                <View>
                <View style={styles.companyTitleView}>
                    <Text style={styles.companyTitle}>Burger SING</Text>
