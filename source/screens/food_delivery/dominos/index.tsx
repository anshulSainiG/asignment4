...
type LogInSignUpProps = NativeStackScreenProps<SignUpStackParamList,'Dominos'>


const Dominos=({navigation}: LogInSignUpProps)=> {
  const[showprice,Setshowprice]=useState<number[]>([])
  return (
    <View style={styles.mainContainer}>
       <Pressable style={styles.companyDetailsBtn} onPress={() =>navigation.navigate("Dominos")}>
            <View style={styles.innerCompanyDetail}>
                <View>
                
                    <Image style={styles.img} source={require("../../../assests/images/Dominos.webp")} />
                </View>
                <View>
                <View style={styles.companyTitleView}>
                    <Text style={styles.companyTitle}>Domino's</Text>
