...
type LogInSignUpProps = NativeStackScreenProps<SignUpStackParamList,'MCDonals'>


const MCDonals = ({ navigation }:LogInSignUpProps) => {
      ...
      <Pressable style={styles.companyDetailsBtn} >
        ...
        <View style={styles.innerCompanyDetail}>
          <View>
            ...
            <Image style={styles.img} source={require("../../../assests/images/mcdonald.jpg")} />
          </View>
          <View>
            <View style={styles.companyTitleView}>
              <Text style={styles.companyTitle}>McDonals</Text>
